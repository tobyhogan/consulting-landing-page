  ...
  return (
    <div className="flex flex-col">
      ...
      <main className="pt-20 pb-10">
        ...
        <h1 className="text-center mt-8 text-2xl">Technical Consulting for Business and Small Business, <br /> Based in Frome, Somereset</h1>
        ...
        <h1 className="text-center text-xl mt-8">Services:</h1>
        <ul className="mx-auto w-fit mt-3 pl-5">
        ...
        <ul className="w-fit mx-auto flex flex-col text-center mt-2">
          ...
          <a href="" className="Link3" target="_blank">UK Kebab</a>
        </ul>
      </main>
      <Footer/>
...
export const Head: HeadFC = () => <title>Kazen Consulting</title>
